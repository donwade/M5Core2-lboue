...
class TFT_eSprite : public TFT_eSPI {
   public:
    ...
    void drawChar(int32_t x, int32_t y, uint16_t c, uint32_t color, uint32_t bg,
        ...
        fillSprite(uint32_t color), fillScreen(uint32_t color),
        ...
        // overhead)
        writeColor(uint16_t color), writeColors(uint16_t *color, uint16_t len),
    ...
    void getSprite2Buff(uint16_t *ptr, int32_t x, int32_t y, int32_t w,
                        int32_t h);
    ...
    void pushImage(int32_t x0, int32_t y0, int32_t w, int32_t h,
                   const uint16_t *data);
    void pushInSprite(TFT_eSprite *spr, int32_t srcX, int32_t srcY,
                      int32_t srcW, int32_t srcH, int32_t desX, int32_t desY);
    ...
    void drawColorBitmap(int32_t x0, int32_t y0, int32_t w, int32_t h,
                         uint8_t *data, uint32_t color, uint32_t bkcolor);
    void drawColorBitmapAlpha(int32_t x0, int32_t y0, int32_t w, int32_t h,
                              uint8_t *data, uint32_t color, uint32_t bkcolor);
   ...
   protected:
    ...
    int32_t _iwidth,
        _iheight;  // Sprite memory image bit width and height (swapped during
                   // rotations)
    int32_t _dwidth,
